...
```
cd existing_repo
git remote add origin https://git.epam.com/roman_kolesnyk/AI-driven-X-stack.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.epam.com/roman_kolesnyk/AI-driven-X-stack/-/settings/integrations)
